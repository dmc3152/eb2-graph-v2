...
import type { SubscriptionResolvers, TriviaGameUpdateForBoard } from './../../../types.generated';
export const joinTriviaGameAsBoard: NonNullable<SubscriptionResolvers['joinTriviaGameAsBoard']> = {
    ...
    resolve: (payload: TriviaGameUpdateForBoard) => payload
}